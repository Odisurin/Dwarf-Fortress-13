/mob/living/simple_animal/hostile/troll
	...
	see_in_dark = 1
	butcher_results = list(/obj/item/food/meat/slab/troll = list(2,3), /obj/item/stack/ore/stone = list(3,6), /obj/item/stack/sheet/mineral/coal = list(1,5),/obj/item/food/intestines=list(1,3))
